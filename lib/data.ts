...
export function useAdmissions() {
  const initialAdmissions: Admission[] = [
    { id: '1', name: 'Emmanuel Tumusiime', class: 'P.1', parent: 'Mr. Tumusiime', phone: '0770XXX', email: 'tumusiime@email.ug', status: 'pending', date: '2026-04-20', dob: '2020-03-15', gender: 'Male' },
    { id: '2', name: 'Ruth Akello', class: 'S.1', parent: 'Mrs. Akello', phone: '0772XXX', email: 'akello@email.ug', status: 'approved', date: '2026-04-18', dob: '2010-07-22', gender: 'Female' },
    { id: '3', name: 'Steven Mwesigwa', class: 'P.4', parent: 'Mr. Mwesigwa', phone: '0773XXX', email: 'mwesigwa@email.ug', status: 'pending', date: '2026-04-19', dob: '2016-01-10', gender: 'Male' },
  ];
