...
<style>body{font-family:Arial,sans-serif;padding:40px;max-width:1000px;margin:0 auto}
h1{text-align:center;color:#1a365d;margin-bottom:5px}h2{text-align:center;color:#666;font-weight:normal;margin-top:0}
...
.time{font-weight:bold;background:#f0f4f8;width:120px}
.break{background:#fef9c3;color:#854d0e;font-style:italic}
@media print{body{padding:20px}}</style></head><body>
<h1>SmartSchool Pro</h1><h2>Weekly Timetable — ${selectedClass}</h2>
...
<p style="text-align:center;font-size:10px;color:#999;margin-top:30px">Generated by SmartSchool Pro — ${new Date().toLocaleDateString()}</p>
</body></html>`);
